...
from hypernets.pipeline.base import Pipeline, HyperTransformer
...
def categorical_pipeline_simple(seq_no=0):
    ...
    pipeline = Pipeline(steps, columns=_cs.column_object_category_bool, name=f'categorical_pipeline_simple_{seq_no}')
    return pipeline
...
def numeric_pipeline_simple(impute_strategy='mean', seq_no=0):
    ...
    pipeline = Pipeline(steps,
                        columns=_cs.column_number_exclude_timedelta,
